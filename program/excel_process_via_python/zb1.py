...
wb = openpyxl.load_workbook('data_1_2.xlsx')
sheet = wb.get_sheet_by_name('1')
sheet_2 = wb.get_sheet_by_name('2')
wb.create_sheet('combined12')
wb.save('data_1_2.xlsx')
sheet_combine = wb.get_sheet_by_name('combined12')
...
id_1, name_1, data_1 = read_excel(sheet,9648, 129)
id_2, name_2, data_2= read_excel(sheet_2, 4798, 163)
