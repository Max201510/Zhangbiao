...
wb = openpyxl.load_workbook('Yangdai_otutable_unoise3_minsize2.xlsx')
sheet = wb.get_sheet_by_name('5')
...
id_1, name_1, data_1 = read_excel(sheet,48756, 129)
id_2, name_2, data_2= read_excel(sheet_2, 24012, 163)
